...
old_item_disc = r"""              <label className="p-4 bg-slate-50 border border-slate-200 rounded-2xl flex items-start gap-3\.5 cursor-pointer hover:bg-slate-100/70 transition">
...
new_item_disc = """              <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl flex flex-col gap-3 transition">
...
content = re.sub(old_item_disc, new_item_disc, content)
