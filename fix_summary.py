...
# Fix the total amount usage
content = content.replace("totalAmount.toFixed(2)", "totals.total.toFixed(2)")

# The summary block replacement
old_summary_block = """      <div className="flex flex-wrap justify-between items-center gap-2 bg-white px-3 py-2 rounded-xl border border-slate-200 shadow-xs shrink-0 mb-1">
